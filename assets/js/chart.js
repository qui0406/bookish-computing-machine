...
function graphDay(){ 
    ...
    for(let i=0; i<data.length; i++){ 
      ...
      if(currrentTimeInput>=limestoneTimeDay && currrentTimeInput< limestoneTimeDay +86400000){
...
function graphWeek(){
  ...
  for(let i=0; i<data.length; i++){ 
    ...
    if(currrentTimeInput>=limestoneTimeWeek && currrentTimeInput<= limestoneTimeWeek + 604800000){
      if(data[i].type=='Ăn uống'){
